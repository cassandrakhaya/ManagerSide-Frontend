    ...
    return (
        <div className="w-1/4 bg-white shadow-lg rounded-lg p-4">
            ...
            <button 
                ...
                onClick={() => setSelectedItem({ name: '', price: '', category: selectedCategory, description: '' })}
            >
                New product
            </button>

            <h2 className="text-lg font-semibold mt-4 mb-2">{selectedCategory.toUpperCase()}</h2>
            <ul>
...
//             <button className="bg-blue-500 text-white w-full p-2 rounded mb-2">New product</button>
